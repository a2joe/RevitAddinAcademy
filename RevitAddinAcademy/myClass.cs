...
namespace RevitAddinAcademy
{
    ...
    public static class Utilities
    {
        ...
        public static string GetParamValueAsString(Element curElem, string paramValue)
        {
            foreach(Parameter curParam in curElem.Parameters)
            {
                if (curParm.Definition.Name == paramName)
                    return curParm.AsString();
            }
            return null;
        }
        public static double GetParamValueAsDouble(Element curElem, string paramValue)
        {
            foreach (Parameter curParam in curElem.Parameters)
            {
                if (curParm.Definition.Name == paramName)
                    return curParm.AsDouble();
            }
            return null;
        }
